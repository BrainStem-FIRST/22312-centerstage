...
public class AutoRR extends ActionOpMode{
    HuskyLens huskyLens;
...
//    public static Vector2d vRedClearStageGate = new Vector2d(TILE_CENTER_TO_CENTER / 2.0, -TILE_CENTER_TO_CENTER / 2.0);
    public static Vector2d vRedClearStageGate = new Vector2d(12, -36);
    ...
    public void runOpMode() {
        ...
        // Assume RED-RIGHT for now

        // Setup possible trajectories
        Pose2d startingPose = pStartingPose_RedRight;
...
//                        .build();
        ...
        Action traj_center =
                drive.actionBuilder(startingPose)
                        ...
                        .lineToY(vRedRightSpike_Center.y + robot_length / 4)
        ...
        Action traj_left =
                drive.actionBuilder(startingPose)
                        ...
                        .splineTo(vRedRightSpike_Left, Math.toRadians(90))
                        .lineToY(vRedRightSpike_Left.y + robot_length / 2)
        ...
        Action traj_right =
                drive.actionBuilder(startingPose)
                        ...
                        .lineToYSplineHeading(vRedRightSpike_Right.y, Math.toRadians(0))
                        .endTrajectory()
                        .lineToX(vRedRightSpike_Right.x - robot_length / 2)
