...
public class Constants {
    public final String NUMBER_OF_PIXELS = "NUMBER_OF_PIXELS";

    public final String PIXEL_CYCLE = "PIXEL_CYCLE";
    public final String PIXEL_CYCLE_INTAKE_INTAKING = "PIXEL_CYCLE_INTAKE";
    public final String PIXEL_CYCLE_INTAKE_SPITTING = "PIXEL_CYCLE_INTAKE_SPITTING";
    public final String PIXEL_CYCLE_FULCRUM_MOVE_UP = "PIXEL_CYCLE_FULCRUM_MOVE_UP";
    public final String PIXEL_CYCLE_FULCRUM_MOVE_DOWN = "PIXEL_CYCLE_FULCRUM_MOVE_DOWN";
