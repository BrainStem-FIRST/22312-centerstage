...
public class AutoConstants {
    ...
    public static Vector2d vBlueLeftSpike_Center = new Vector2d(0.5 * TILE_CENTER_TO_CENTER, TILE_CENTER_TO_CENTER + TILE_TEETH / 2.0 + 5.0);
    public static Vector2d vBlueLeftSpike_Right = new Vector2d(TILE_CENTER_TO_CENTER - TILE_TEETH / 2.0 - 9.0, TILE_CENTER_TO_CENTER + TILE_TEETH / 2.0 + 2.0);
...
//    public static Vector2d vRedBackdrop_Right = new Vector2d(36, -40);
    ...
    public static Vector2d vBlueBackdrop_Right = new Vector2d(FIELD_BACKDROP_X - MAX_DISTANCE_BEFORE_CRASH - robot_length/2.0 - 9.0, FIELD_BLUE_BACKDROP_RIGHT_Y - 4.0);
