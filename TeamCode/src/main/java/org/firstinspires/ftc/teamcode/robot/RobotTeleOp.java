...
//            }
            if(gamepad2.b){
                stateMap.put(robot.hanging.HANGING_SYSTEM_NAME, robot.hanging.SERVO_RELEASED);
            }

            if(gamepad2.right_trigger > 0.5){
                robot.hanging.hangingMotor.setPower(gamepad2.right_trigger);
            } else{
                robot.hanging.hangingMotor.setPower(0);
            }
